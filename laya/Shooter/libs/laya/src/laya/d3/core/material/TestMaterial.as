package laya.d3.core.material {
	...
	/**
	 * <code>TestMaterial</code> 类用于实现Blinn-Phong材质。
	 */
	public class TestMaterial extends BaseMaterial {
		...
		/** 默认材质，禁止修改*/
		public static const defaultMaterial:TestMaterial = new TestMaterial();
		...
		public function set enableVertexColor(value:Boolean):void {
			...
			if (value)
				_defineDatas.add(TestMaterial.SHADERDEFINE_ENABLEVERTEXCOLOR);
			else
				_defineDatas.remove(TestMaterial.SHADERDEFINE_ENABLEVERTEXCOLOR);
		}
		...
		public function set tilingOffset(value:Vector4):void {
			if (value) {
				...
				if (valueE[0] != 1 || valueE[1] != 1 || valueE[2] != 0 || valueE[3] != 0)
					_defineDatas.add(TestMaterial.SHADERDEFINE_TILINGOFFSET);
				else
					_defineDatas.remove(TestMaterial.SHADERDEFINE_TILINGOFFSET);
			} else {
				_defineDatas.remove(TestMaterial.SHADERDEFINE_TILINGOFFSET);
			}
		...
		public function set albedoTexture(value:BaseTexture):void {
			if (value)
				_defineDatas.add(TestMaterial.SHADERDEFINE_DIFFUSEMAP);
			else
				_defineDatas.remove(TestMaterial.SHADERDEFINE_DIFFUSEMAP);
		...
		public function set normalTexture(value:BaseTexture):void {
			if (value)
				_defineDatas.add(TestMaterial.SHADERDEFINE_NORMALMAP);
			else
				_defineDatas.remove(TestMaterial.SHADERDEFINE_NORMALMAP);
		...
		public function set specularTexture(value:BaseTexture):void {
			if (value)
				_defineDatas.add(TestMaterial.SHADERDEFINE_SPECULARMAP);
			else
				_defineDatas.remove(TestMaterial.SHADERDEFINE_SPECULARMAP);
		...
		/**
		 * 创建一个 <code>TestMaterial</code> 实例。
		 */
		...
		override public function cloneTo(destObject:*):void {
			...
			var destMaterial:TestMaterial = destObject as TestMaterial;
