package laya.d3.shader {
	...
	import laya.d3.core.material.SeaMaterial;
	...
	public class ShaderInit3D {
		...
		public static function __init__():void {
			...
			attributeMap = {
				'_glesVertex': VertexMesh.MESH_POSITION0, 
				'_glesNormal': VertexMesh.MESH_NORMAL0,
				'_glesMultiTexCoord0': VertexMesh.MESH_TEXTURECOORDINATE0,
				'_glesTANGENT': VertexMesh.MESH_TANGENT0
			};
			uniformMap = {
				'unity_MatrixVP': [Sprite3D.VPMATRIX, Shader3D.PERIOD_SPRITE], 
				'unity_ObjectToWorld': [Sprite3D.WORLDMATRIX, Shader3D.PERIOD_SPRITE],
				'unity_WorldToObject': [Sprite3D.LOCALMATRIX, Shader3D.PERIOD_SPRITE],
				'_WorldSpaceCameraPos': [BaseCamera.CAMERAPOS, Shader3D.PERIOD_CAMERA],
				'_Time': [Scene3D.UNITY_TIME, Shader3D.PERIOD_SCENE], 

				'spltex_ST' : [SeaMaterial.SPLTEXOFFSET, Shader3D.PERIOD_MATERIAL],
				'displacement_ST' : [SeaMaterial.DISPLACEOFFSET, Shader3D.PERIOD_MATERIAL],
				'normalTexture_ST' : [SeaMaterial.NORMALTEXOFFSET, Shader3D.PERIOD_MATERIAL],
				'foamTexture_ST' : [SeaMaterial.FOAMTEXOFFSET, Shader3D.PERIOD_MATERIAL],
				'reflectionTex_ST' : [SeaMaterial.REFTEXOFFSET, Shader3D.PERIOD_MATERIAL],
				'wavesTexture_ST' : [SeaMaterial.WTOFFSET, Shader3D.PERIOD_MATERIAL],
				'maskWavesDisplacement_ST' : [SeaMaterial.MVDOFFSET, Shader3D.PERIOD_MATERIAL],
				'fresnelColor' : [SeaMaterial.FRESNELCOLOR, Shader3D.PERIOD_MATERIAL],
				'objScale' : [SeaMaterial.OBJSCALE, Shader3D.PERIOD_MATERIAL],
				'waterColor' : [SeaMaterial.WATERCOLOR, Shader3D.PERIOD_MATERIAL],
				'reflectionColor' : [SeaMaterial.REFLECTIONCOLOR, Shader3D.PERIOD_MATERIAL],


				'spltex' : [SeaMaterial.SPLTEX, Shader3D.PERIOD_MATERIAL],
				'displacement' : [SeaMaterial.DESTEXTURE, Shader3D.PERIOD_MATERIAL],
				'normalTexture' : [SeaMaterial.NORMALTEXTURE, Shader3D.PERIOD_MATERIAL],
				'foamTexture' : [SeaMaterial.FOAMTEXTURE, Shader3D.PERIOD_MATERIAL],
				'reflectionTex' : [SeaMaterial.REFLECTTEXTURE, Shader3D.PERIOD_MATERIAL],
				'wavesTexture' : [SeaMaterial.WAVESTEXTURE, Shader3D.PERIOD_MATERIAL],
				'maskWavesDisplacement' : [SeaMaterial.MASKWAVESTEXTURE, Shader3D.PERIOD_MATERIAL],

	 
				'spec' : [SeaMaterial.SPECNUM, Shader3D.PERIOD_MATERIAL],
				'reflectionIntensity' : [SeaMaterial.REFINVNUM, Shader3D.PERIOD_MATERIAL],
				'reflectionFresnel' : [SeaMaterial.REFFRENUM, Shader3D.PERIOD_MATERIAL],
				'gloss' : [SeaMaterial.GLOSS, Shader3D.PERIOD_MATERIAL],
				'displacementSpeed': [SeaMaterial.DISPLACEMENTSPEED, Shader3D.PERIOD_MATERIAL],
				'displacementScale': [SeaMaterial.DISPLACEMENTSCALE, Shader3D.PERIOD_MATERIAL],
				'displacementIntensity': [SeaMaterial.DISPLACEMENTINTENSITY, Shader3D.PERIOD_MATERIAL],
				'normalIntensity': [SeaMaterial.NORMALINTENSITY, Shader3D.PERIOD_MATERIAL],
				'wavesScale': [SeaMaterial.WAVESCALE, Shader3D.PERIOD_MATERIAL],
				'wavesDisplacementSpeed': [SeaMaterial.WAVESDISPLACEMENTSPEED, Shader3D.PERIOD_MATERIAL],
				'sceneZ': [SeaMaterial.SCENEZ, Shader3D.PERIOD_MATERIAL],
				'partZ': [SeaMaterial.PARTZ, Shader3D.PERIOD_MATERIAL],
				'displacementFoamIntensity': [SeaMaterial.DISPLACEMENTFOAMINTENSITY, Shader3D.PERIOD_MATERIAL],
				'shoreFoamIntensity': [SeaMaterial.SHOREFOAMINTENSITY, Shader3D.PERIOD_MATERIAL],
				'shoreLineOpacity': [SeaMaterial.SHORELINEOPACITY, Shader3D.PERIOD_MATERIAL],
				'savesDisplacementFoamIntensity': [SeaMaterial.SAVEDISPLACEMENTFOAMINTENSITY, Shader3D.PERIOD_MATERIAL],
				'fadeLevel': [SeaMaterial.FADELEVEL, Shader3D.PERIOD_MATERIAL],
				'shoreFoamDistance': [SeaMaterial.SHOREFOAMDISTANCE, Shader3D.PERIOD_MATERIAL],
				'wavesAmount': [SeaMaterial.WAVESAMOUNT, Shader3D.PERIOD_MATERIAL],
				'wavesSpeed': [SeaMaterial.WAVESSPEED, Shader3D.PERIOD_MATERIAL],
				'wavesIntensity': [SeaMaterial.WAVESINTENSITY, Shader3D.PERIOD_MATERIAL],
				'radialWaves': [SeaMaterial.RADIALWAVES, Shader3D.PERIOD_MATERIAL],
				'waterDensity': [SeaMaterial.WATERDENSITY, Shader3D.PERIOD_MATERIAL],
				'shoreWaterOpacity': [SeaMaterial.SHOREWATEROPACITY, Shader3D.PERIOD_MATERIAL],
				'waveHeight': [SeaMaterial.WAVEHEIGHT, Shader3D.PERIOD_MATERIAL],
				'vHeight': [SeaMaterial.VHEIGHT, Shader3D.PERIOD_MATERIAL],
				'foamScale': [SeaMaterial.FOAMSCALE, Shader3D.PERIOD_MATERIAL],
				'foamSpeed': [SeaMaterial.FOAMSPEED, Shader3D.PERIOD_MATERIAL],
				'skyBlur': [SeaMaterial.SKYBLUR, Shader3D.PERIOD_MATERIAL],

				'LightColor0': [Scene3D.LIGHTDIRCOLOR, Shader3D.PERIOD_SCENE],
				'LightDir0': [Scene3D.LIGHTDIRECTION, Shader3D.PERIOD_SCENE], 

				'reflectionmapColor' : [SeaMaterial.REFLECTIONCOLOR, Shader3D.PERIOD_MATERIAL]

				
			};
			console.log("add sea");
			vs = __INCLUDESTR__("files/Sea.vs");
			ps = __INCLUDESTR__("files/Sea.ps");
