package laya.d3.core.scene {
	...
	public class Scene3D extends Sprite implements ISubmit, ICreateResource {
		...
		public static const UNITY_TIME:int = 29;
		...
		private var _unity_time:Vector4 = new Vector4(0,0,0,0);
		...
		private function _update():void {
			...
			_time += delta;
			//_unity_time.y += timer._delta;
			_unity_time.y = _time;
			_unity_time.x = _unity_time.y/20;
			_unity_time.z = _unity_time.y*2;
			_unity_time.w = _unity_time.y*3;
			
			_shaderValues.setNumber(Scene3D.TIME, _time);
			_shaderValues.setVector(Scene3D.UNITY_TIME,_unity_time);
