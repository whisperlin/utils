Shader "LayaAir3D/LayaBlinnPhongDetail" {
	Properties {
		_MainTex("Albedo Texture", 2D) = "white" {}
		_DetailMap("_DetailMap",2D) = "white" {}
		_Color("Albedo Color", Color) = (1,1,1,1)
		_AlbedoIntensity("Albedo Intensity", Range(1.0, 4.0)) = 1.0
	uvtile1("uvtile1" ,Range(-30.0,30.0) )= 1
	uvtile2("uvtile2" ,Range(-30.0,30.0) )= 1
		_vertexMap ("_vertexMap",2D ) = "white" {}
	...
	SubShader {		
		...
		Pass { 
			...
			#include "../CGIncludes/LayaBlinnPhongFBDetail.cginc"
