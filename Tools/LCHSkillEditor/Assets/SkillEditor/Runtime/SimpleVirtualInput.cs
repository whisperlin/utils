...
public class SimpleVirtualInput : MonoBehaviour {
	...
	void Update () {
        ...
        VirtualInput.buttons[4] = Input.GetKey(button4);
        VirtualInput.buttons[5] = Input.GetKey(button5);
        VirtualInput.buttons[6] = Input.GetKey(button6);
        VirtualInput.buttons[7] = Input.GetKey(button7);
        VirtualInput.buttons[8] = Input.GetKey(button8);
        VirtualInput.buttons[9] = Input.GetKey(button9);
        VirtualInput.buttons[19] = Input.GetKey(jump);
