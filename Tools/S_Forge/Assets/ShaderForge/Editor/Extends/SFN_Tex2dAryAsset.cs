...
namespace ShaderForge {
	[System.Serializable]
	public class SFN_Tex2dAryAsset : SF_Node {
		...
		public SFN_Tex2dAryAsset() {

		}

		public override void Initialize() {
			base.Initialize( "Texture2DArray Asset", InitialPreviewRenderMode.BlitQuad );
			...
			connectors = new SF_NodeConnector[]{
				SF_NodeConnector.Create(this,"2DAry","2DAry",ConType.cOutput,ValueType.TexAsset).WithColor(SF_Node.colorExposed)
			};
		}
