...
Shader "ProjectQ/GFX/Complex/Dissolve_Alpha" {
    Properties {
        _Diffuse_Textures ("Diffuse_Textures", 2D) = "white" {}
        _AlphaTextures ("Alpha_Textures", 2D) = "white" {}
        ...
        _Age_Color ("Age_Color", Color) = (0.5,0.5,0.5,1)
    }
    SubShader {
        Tags {
        ...
        Pass {
			...
			//#pragma multi_compile MY_FOG_NONE MY_FOG_LINEAR MY_FOG_EXP MY_FOG_EXP2
			#pragma multi_compile MY_TE_OFF MY_TE_HIGH MY_TE_MID MY_TE_LOW
            ...
            uniform sampler2D _AlphaTextures; uniform half4 _AlphaTextures_ST;
			...
			//	MY_TRANSFER_GFX_FOG(o, worldPos, o.pos.z);
                return o;
            }
			...
			fixed4 frag(VertexOutput i) : COLOR
			{
				...
				float4 _Alpha_Tex = tex2D(_AlphaTextures, i.uv0.xy);
			...
			//	MY_APPLY_FOG(i, finalrgb);
                return fixed4(finalrgb,_Dessolve_Tex.r*_Alpha_Tex.r);  
            }
            ENDCG
        }
    }
