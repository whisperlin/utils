Shader "T4MShaders/ShaderModel3/BumpSpec/T4M 4 Textures Bump Spec Water low" {
Properties {
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	half3 waterNormal = o.Normal + splat_control.a * lerp(baseNormal,bump ,  _WaveNormalPower)  ;
	...
	_SpecColor =   _SpecColor3*splat_control.a;
