Shader "T4MShaders/ShaderModel2/Diffuse/T4M 6 Textures New" {
Properties {
...
void surf (Input IN, inout SurfaceOutput o) {
				...
				col += splat_control.a * tex2D (_Splat3, IN.uv_Control*_Tiling3.xy).rgb;
                col += splat_control2.r* tex2D (_Splat4, IN.uv_Control*_Tiling4.xy).rgb;
                col += splat_control2.g * tex2D (_Splat5, IN.uv_Control*_Tiling5.xy).rgb;
