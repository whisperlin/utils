...
retry:
        ...
        public static FMOD.RESULT PathToGUID(string path, out Guid guid)
        {
            if (path.StartsWith("{"))
            {
                FMOD.Studio.Util.ParseID(path, out guid);
        ...
        public static FMOD.RESULT TryGetEventDescription(Guid guid, out FMOD.Studio.EventDescription eventDesc)
        {
