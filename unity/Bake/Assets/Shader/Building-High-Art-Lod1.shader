...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:False,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:False,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:False,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:2865,x:33921,y:32660,varname:node_2865,prsc:2|normal-3747-OUT,rich5 out-6554-OUT;n:type:ShaderForge.SFN_Tex2d,id:1640,x:33122,y:32126,ptovrint:True,ptlb:Normal Map,ptin:_BumpMap,varname:_BumpMap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:8867,x:32540,y:32771,ptovrint:False,ptlb:Metallic,ptin:_Metallic,varname:node_6358,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,ntxv:2,isnm:False;n:type:ShaderForge.SFN_Cubemap,id:6955,x:32226,y:33143,ptovrint:False,ptlb:SpecIBL,ptin:_SpecIBL,varname:_CubeMap_copy_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,pvfc:0|DIR-1220-OUT;n:type:ShaderForge.SFN_Slider,id:958,x:32445,y:33291,ptovrint:False,ptlb:SpecIBL Power,ptin:_SpecIBLPower,varname:_CubeDiff_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,min:0,cur:0.87,max:10;n:type:ShaderForge.SFN_Multiply,id:2743,x:32937,y:33172,varname:node_2743,prsc:2|A-6955-RGB,B-958-OUT,C-8468-OUT;n:type:ShaderForge.SFN_Tex2d,id:8910,x:32397,y:32022,ptovrint:False,ptlb:Emssion Map,ptin:_EmssionMap,varname:node_3401,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:9125,x:32748,y:32232,varname:node_9125,prsc:2|A-8910-RGB,B-1350-RGB;n:type:ShaderForge.SFN_Color,id:1350,x:32370,y:32281,ptovrint:False,ptlb:Emssion Color,ptin:_EmssionColor,varname:node_657,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,c1:0,c2:0,c3:0,c4:1;n:type:ShaderForge.SFN_Tex2d,id:5127,x:31063,y:32079,ptovrint:False,ptlb:Albedo,ptin:_Albedo,varname:node_5127,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Add,id:5497,x:33610,y:32896,varname:node_5497,prsc:2|A-9125-OUT,B-8096-OUT;n:type:ShaderForge.SFN_RichShadow,id:6554,x:33677,y:33222,varname:node_6554,prsc:2|IN-5497-OUT;n:type:ShaderForge.SFN_FragmentPosition,id:2003,x:30775,y:32902,varname:node_2003,prsc:2;n:type:ShaderForge.SFN_Transform,id:9545,x:30969,y:33008,varname:node_9545,prsc:2,tffrom:0,tfto:1|IN-2003-XYZ;n:type:ShaderForge.SFN_ComponentMask,id:7416,x:31201,y:33041,varname:node_7416,prsc:2,cc1:1,cc2:-1,cc3:-1,cc4:-1|IN-9545-XYZ;n:type:ShaderForge.SFN_Smoothstep,id:1154,x:31263,y:32826,varname:node_1154,prsc:2|A-9878-OUT,B-1183-OUT,V-7416-OUT;n:type:ShaderForge.SFN_ValueProperty,id:9878,x:31052,y:32743,ptovrint:False,ptlb:Min,ptin:_Min,varname:node_9878,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,v1:0;n:type:ShaderForge.SFN_Lerp,id:5382,x:31599,y:32702,varname:node_5382,prsc:2|A-7149-RGB,B-1154-OUT,T-7149-A;n:type:ShaderForge.SFN_Multiply,id:2201,x:32043,y:32489,varname:node_2201,prsc:2|A-7779-OUT,B-5382-OUT;n:type:ShaderForge.SFN_Color,id:7149,x:31294,y:32603,ptovrint:False,ptlb:shaodowColor,ptin:_shaodowColor,varname:node_7149,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,c1:1,c2:1,c3:1,c4:0;n:type:ShaderForge.SFN_ValueProperty,id:1183,x:30951,y:32686,ptovrint:False,ptlb:Max,ptin:_Max,varname:node_1183,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,v1:0;n:type:ShaderForge.SFN_Divide,id:7779,x:31784,y:32266,varname:node_7779,prsc:2|A-9096-OUT,B-7487-OUT;n:type:ShaderForge.SFN_Slider,id:7487,x:31419,y:32424,ptovrint:False,ptlb:To Linrar,ptin:_ToLinrar,varname:node_7487,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,min:-1,cur:1,max:2.2;n:type:ShaderForge.SFN_Tex2d,id:6301,x:30849,y:31758,ptovrint:False,ptlb:AO,ptin:_AO,varname:node_6301,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,ntxv:0,isnm:False|UVIN-3317-UVOUT;n:type:ShaderForge.SFN_Multiply,id:9096,x:31450,y:32237,varname:node_9096,prsc:2|A-8468-OUT,B-2150-OUT;n:type:ShaderForge.SFN_TexCoord,id:3317,x:30627,y:31666,varname:node_3317,prsc:2,uv:1,uaff:False;n:type:ShaderForge.SFN_Slider,id:6571,x:30627,y:31456,ptovrint:False,ptlb:AO Power,ptin:_AOPower,varname:node_6571,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Vector3,id:9212,x:31045,y:31850,varname:node_9212,prsc:2,v1:1,v2:1,v3:1;n:type:ShaderForge.SFN_Lerp,id:8468,x:31424,y:31895,varname:node_8468,prsc:2|A-6301-RGB,B-9212-OUT,T-6571-OUT;n:type:ShaderForge.SFN_Cubemap,id:706,x:32027,y:32727,ptovrint:False,ptlb:DiffIBL,ptin:_DiffIBL,varname:node_706,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,pvfc:0|DIR-6336-OUT;n:type:ShaderForge.SFN_Slider,id:983,x:31694,y:33108,ptovrint:False,ptlb:DiffIBL Power ,ptin:_DiffIBLPower,varname:node_983,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,min:0,cur:1,max:3;n:type:ShaderForge.SFN_Multiply,id:6423,x:32214,y:32777,varname:node_6423,prsc:2|A-706-RGB,B-983-OUT;n:type:ShaderForge.SFN_NormalVector,id:6336,x:31811,y:32740,prsc:2,pt:True;n:type:ShaderForge.SFN_ViewReflectionVector,id:1220,x:32017,y:33108,varname:node_1220,prsc:2;n:type:ShaderForge.SFN_Multiply,id:5526,x:33913,y:32138,varname:node_5526,prsc:2|A-1036-OUT,B-2395-OUT;n:type:ShaderForge.SFN_Append,id:1036,x:33595,y:32292,varname:node_1036,prsc:2|A-1640-R,B-1640-G;n:type:ShaderForge.SFN_Append,id:3747,x:33813,y:32454,varname:node_3747,prsc:2|A-5526-OUT,B-1640-B;n:type:ShaderForge.SFN_Slider,id:2395,x:33451,y:32120,ptovrint:False,ptlb:Normal Intensiy,ptin:_NormalIntensiy,varname:node_2395,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,min:0,cur:1,max:2;n:type:ShaderForge.SFN_Multiply,id:7954,x:32885,y:32587,varname:node_7954,prsc:2|A-4549-OUT,B-8867-R;n:type:ShaderForge.SFN_Multiply,id:9825,x:33069,y:32831,varname:node_9825,prsc:2|A-3592-OUT,B-8867-A;n:type:ShaderForge.SFN_Slider,id:4549,x:32418,y:32417,ptovrint:False,ptlb:MetallicIn,ptin:_MetallicIn,varname:node_4549,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,min:0,cur:1,max:1.1;n:type:ShaderForge.SFN_Slider,id:3592,x:32793,y:32994,ptovrint:False,ptlb:GlossIn,ptin:_GlossIn,varname:_Metallic_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Color,id:125,x:31028,y:32300,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_125,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,taginstsco:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:2150,x:31238,y:32264,varname:node_2150,prsc:2|A-5127-RGB,B-125-RGB;n:type:ShaderForge.SFN_PBRLod,id:8096,x:33327,y:32331,varname:node_8096,prsc:2|MainTex-2201-OUT,Metallic_alpha-8867-A,Metallic_red-8867-R,DiffCubemap-6423-OUT,SpecCubemap-2743-OUT;proporder:125-5127-8910-1350-1640-2395-8867-706-983-6955-958-9878-7149-1183-7487-6301-6571-4549-3592;pass:END;sub:END;*/

Shader "DAFUHAO_Editor/Building-High-Art-Lod1" {
    Properties {
...
////// Lighting:
                ...
                float4 finalColor = FINAL_SHADOW_COLOR_SINGLE(((_EmssionMap_var.rgb*_EmssionColor.rgb)+PBRSpecularLow(normalDirection, 
                                    viewDirection,float3(0,0,0),_Metallic_var.a,_Metallic_var.r,(((node_8468*(_Albedo_var.rgb*_Color.rgb))/_ToLinrar)*lerp(_shaodowColor.rgb,float3(node_1154,node_1154,node_1154),_shaodowColor.a)),(texCUBE(_DiffIBL,normalDirection).rgb*_DiffIBLPower),(texCUBE(_SpecIBL,viewReflectDirection).rgb*_SpecIBLPower*node_8468))), i, normalDirection);
                finalColor.a *= 1;
                #ifdef BAKEMOD_ON
                float4  res = 1;
