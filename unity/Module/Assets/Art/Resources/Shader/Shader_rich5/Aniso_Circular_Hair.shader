Shader "DAFUHAO_Editor/Character/Aniso Circular Hair" {
	Properties {
	  ...
	  #include "../CGIncludes/RolantinCG.cginc"
		...
		float4 frag (vertexout i):Color{
			fixed3 Albedo;
                ...
                float4 _maskmap_var = tex2D(_maskmap,i.uv0); 
			...
			return float4(c.rgb,Alpha*_maskvalue);
		}
		ENDCG
	}
