...
Shader "Hair/HairPBR" {
    Properties {
        _Color ("头发颜色", Color) = (0.5019608,0.5019608,0.5019608,1)
         _SpecularColor ("高光色", Color) = (1,1,1,1)
         _SpecularPower ("高光强度", Range(0, 1)) = 0.3
        _MainTex ("头发贴图", 2D) = "white" {}
...
////// Specular:
                ...
                float LdotH = max(0.0,dot(lightDirection, halfDirection));
 				...
 				float3 specularColor = _SpecularColor *_SpecularPower;
