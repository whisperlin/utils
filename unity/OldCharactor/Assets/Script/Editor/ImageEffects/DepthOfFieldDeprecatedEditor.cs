...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class DepthOfFieldDeprecatedEditor : Editor
    {
        ...
        SerializedProperty dofShader;
        SerializedProperty dofBlurShader;
        SerializedProperty bokehShader;
        ...
        void OnEnable () {
            ...
            dofShader = serObj.FindProperty("dofShader");
            dofBlurShader = serObj.FindProperty("dofBlurShader");
            bokehShader = serObj.FindProperty("bokehShader");
        }
        ...
        public override void OnInspectorGUI () {
            ...
            EditorGUILayout.PropertyField(dofShader, new GUIContent(" dofShader"));
            EditorGUILayout.PropertyField(dofBlurShader, new GUIContent(" dofBlurShader"));
            EditorGUILayout.PropertyField(bokehShader, new GUIContent(" bokehShader"));
