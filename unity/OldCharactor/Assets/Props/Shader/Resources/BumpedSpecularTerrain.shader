	...
	SubShader
	{
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed3 Smoothness;
				Smoothness = (_Smoothness.x * splat_control.r + _Smoothness.y * splat_control.g + _Smoothness.z * splat_control.b + _Smoothness.x * splat_control.a) * sR;
