...
namespace UnityEngine.PostProcessing
{
    ...
    public class PostProcessingBehaviour : MonoBehaviour
    {
		...
		void OnPreRender()
		{
			...
			myRenderTexture = RenderTexture.GetTemporary(Screen.width, Screen.height, 24, RenderTextureFormat.DefaultHDR,RenderTextureReadWrite.Default,2);
		...
		void OnPostRender()
		{
			...
			RenderImage(myRenderTexture, null as RenderTexture);
