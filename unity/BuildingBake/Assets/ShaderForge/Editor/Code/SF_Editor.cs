...
namespace ShaderForge {
	...
	public class SF_Editor : EditorWindow {
		...
		public void InitializeNodeTemplates() {
            ...
            AddTemplate( typeof(SFN_AddAndMultipy),     catArithmetic + "Add and multipy");
            AddTemplate(typeof(SFN_PBR), catArithmetic + "pbr");
			AddTemplate(typeof(SFN_PBRLod), catArithmetic + "pbr  lod");
			AddTemplate(typeof(SFN_PBRLod2), catArithmetic + "pbr  lod not sp");
			AddTemplate(typeof(SFN_NDotL_r), catArithmetic + "NdotL  rich");
			AddTemplate(typeof(SF_Light0ColorRich), catArithmetic + "LightColor0 x Intensity0  rich");

            AddTemplate(typeof(SFN_Enviment), catArithmetic + "envirment");
            AddTemplate(typeof(SFN_GroundEnvirment), catArithmetic + "ground envirment");
            ...
            AddTemplate(typeof(SFN_Specular), catProps + "Specular");
            AddTemplate(typeof(SFN_VirtualLightsDiffuse), catProps + "virtual lights");
            AddTemplate(typeof(SFN_RichShadow), catProps + "rich5 shadow");
            ...
            AddTemplate(typeof(SFN_RichMainST),  catProps + "rich5 main_st");
            AddTemplate(typeof(SFN_RichSplit), catProps + "rich5 split");
