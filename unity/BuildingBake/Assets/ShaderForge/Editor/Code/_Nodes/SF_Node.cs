...
//		}
		...
		public void ContextClick( object o ) {
			...
			case "tagnsco":
                ...
                case "taginstsco":
                    property.tagInstancingTiling = !property.tagInstancingTiling;
                    editor.ShaderOutdated = UpToDateState.OutdatedHard;
                    break;
				...
				if( MouseOverNode( world: true ) ) {
					...
					if( IsProperty() && property.global == false ) {
						...
						if( property is SFP_Tex2d ) {
                            ...
                            menu.AddItem(new GUIContent("[instance scale an offset]"), property.tagInstancingTiling, ContextClick, "taginstsco");
