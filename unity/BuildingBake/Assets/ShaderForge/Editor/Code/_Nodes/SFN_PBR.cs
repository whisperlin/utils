...
namespace ShaderForge
{
    public class SFN_PBR : SF_Node
    {
        ...
        public override void Initialize()
        {
            ...
            */
            connectors = new SF_NodeConnector[]{
                ...
                SF_NodeConnector.Create(this,"SpecCubemap","SpecCubemap",ConType.cInput,ValueType.VTv3,false).SetRequired(false)
            };
        }
        ...
        public override string Evaluate(OutChannel channel = OutChannel.All)
        {
            ...
            return string.Format(@"PBRSpecular(normalDirection, 
