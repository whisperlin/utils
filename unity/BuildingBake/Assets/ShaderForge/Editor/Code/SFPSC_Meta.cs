...
namespace ShaderForge {
	...
	public class SFPSC_Meta : SFPS_Category {
        ...
        //public bool rich5BuildingShader = false;
		...
		*/
		...
		public override string Serialize(){
            ...
            //s += Serialize("rich5", rich5BuildingShader.ToString());
			return s;
		}
		...
		public override float DrawInner(ref Rect r){
            ...
            //rich5BuildingShader = UndoableToggle(r, rich5BuildingShader, "大富豪地图建筑用shader!", "大富豪地图建筑用shader!", null);
            //r.y += 20;
