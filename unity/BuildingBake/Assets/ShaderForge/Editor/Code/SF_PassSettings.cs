...
namespace ShaderForge {
	...
	public class SF_PassSettings : ScriptableObject {
        ...
        public string n_rich5out
        {
            get { return mOut.Rich5Output.TryEvaluate(); }
        }
        ...
        public bool HasRich5Output()
        {
            return mOut.Rich5Output.IsConnectedEnabledAndAvailable();
        }

        public bool HasRich5ShadowUsed()
        {
            if (mOut.Rich5Output.IsConnectedEnabledAndAvailable())
            {
                SFN_RichShadow rsNode = mOut.Rich5Output.inputCon.node as SFN_RichShadow;
                return rsNode != null;
            }
...
//         bool HasVirtualLightUse(SF_Node node)
//         {
//             if (node is SFN_VirtualLightsDiffuse)
//                 return true;
// 
//             SF_NodeConnector[] conns = node.ConnectedInputs;
//             for (int i = 0, c = conns.Length; i < c; i++)
//             {
//                 if (conns[i] != null && 
//                     conns[i].inputCon != null &&
//                     conns[i].inputCon.node != null && 
//                     HasVirtualLightUse(conns[i].inputCon.node))
//                     return true;
//             }
// 
//             return false;
//         }
// 
//         public bool HasRich5VirtualLightUse()
//         {
//             if (mOut.Rich5Output.IsConnectedEnabledAndAvailable())
//             {
//                 SF_Node sfNode = mOut.Rich5Output.inputCon.node;
//                 return HasVirtualLightUse(sfNode);
//             }
// 
//             return false;
//         }
