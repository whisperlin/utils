	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				IN.vertex.xyz = mul( IN.vertex.xyz , unity_ObjectToWorld );
				IN.vertex.xyz = mul( IN.vertex.xyz , rotationCamMatrix );
				IN.vertex.xyz = mul( IN.vertex.xyz , unity_WorldToObject );
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 screenPos21 = screenPos;
				#if UNITY_UV_STARTS_AT_TOP
				float scale21 = -1.0;
				#else
				float scale21 = 1.0;
				#endif
				float halfPosW21 = screenPos21.w * 0.5;
				screenPos21.y = ( screenPos21.y - halfPosW21 ) * _ProjectionParams.x* scale21 + halfPosW21;
				#ifdef UNITY_SINGLE_PASS_STEREO
				screenPos21.xy = TransformStereoScreenSpaceTex(screenPos21.xy, screenPos21.w);
				#endif
				screenPos21.xyzw /= screenPos21.w;
				...
				float4 lerpResult20 = lerp( tex2DNode2 , tex2D( _TextureSample2, ( (screenPos21).xy * _ScreenTiling ) ) , tex2D( _Mask, appendResult44 ).r);
				...
				#endif
				float4 appendResult6 = (float4((lerpResult20).xyz , simpleKeywordVar9));
...
/*ASEBEGIN
Version=13001
488;92;947;650;-294.1048;465.2946;1.3;True;False
Node;AmplifyShaderEditor.CommentaryNode;52;-1945.601,-207.0965;Float;False;917.006;381.7991;Comment;5;23;24;21;22;14;Fetch screen position;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GrabScreenPosition;21;-1895.601,-157.0964;Float;False;0;0;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;18;-924.6993,-700.197;Float;True;Property;_Mask;Mask;1;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SamplerNode;14;-1349.595,-56.79973;Float;True;Property;_TextureSample2;Texture Sample 2;0;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SamplerNode;2;-670.201,96.29993;Float;True;Property;_TextureSample0;Texture Sample 0;0;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;3;-832.8002,383.2996;Float;False;_AlphaTex;0;1;SAMPLER2D
Node;AmplifyShaderEditor.LerpOp;20;-308.7964,-88.29664;Float;False;3;0;FLOAT4;0.0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0.0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.SwizzleNode;5;-92.3997,-51.5002;Float;False;FLOAT3;0;1;2;3;1;0;FLOAT4;0.0,0,0,0;False;1;FLOAT3
Node;AmplifyShaderEditor.KeywordSwitchNode;9;-181.0002,282.0994;Float;False;ETC1_EXTERNAL_ALPHA;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
ASEEND*/
//CHKSM=8A0D729F94613B429F9D5FFA88160CB491F6026D