...
Shader "ASESampleShaders/Double Layer Custom Surface"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float fresnelFinalVal201 = (0.05 + 1.0*pow( 1.0 - dot( ase_worldNormal, worldViewDir ) , 1.0));
			...
			s1.Albedo = lerp( lerp( _BaseColor1 , _BaseColor2 , fresnelFinalVal201 ) , lerp( lerp( _FlakesColor1 , _FlakesColor2 , fresnelFinalVal201 ) , tex2DNode228 , _FlakeColorVariationAmount ) , FlakeMask284 ).xyz;
			...
			s1.Metallic = lerp( _BaseMetallic , _FlakesMetallic , FlakeMask284 );
			s1.Smoothness = lerp( _BaseSmoothness , _FlakesSmoothness , FlakeMask284 );
			float fresnelFinalVal279 = (0.05 + 1.0*pow( 1.0 - dot( ase_worldNormal, worldViewDir ) , 5.0));
			float temp_output_306_0 = lerp( i.vertexColor.r , 1.0 , _BaseOcclusion );
			s1.Occlusion = ( saturate( ( 1.0 - fresnelFinalVal279 ) ) * temp_output_306_0 );

			Unity_GlossyEnvironmentData g1;
			g1.roughness = 1 - s1.Smoothness;
			g1.reflUVW = reflect( -data.worldViewDir, s1.Normal );
			UnityGI gi1 = UnityGlobalIllumination( data, s1.Occlusion, s1.Normal, g1 );
			...
			UnityGI gi166 = UnityGlobalIllumination( data, s166.Occlusion, s166.Normal, g166 );

			float3 surfResult166 = LightingStandardSpecular ( s166, viewDir, gi166 ).rgb;

			c.rgb = lerp( surfResult1 , surfResult166 , ( ( fresnelFinalVal279 * _CoatAmount ) * temp_output_306_0 ) );
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=11004
438;572;1034;446;3756.343;492.7622;7.600002;True;False
Node;AmplifyShaderEditor.CommentaryNode;292;-1556.492,-259.3257;Float;False;301.1;308.8;Comment;1;201;Dual Toning Factor;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;293;-611.7687,-557.9827;Float;False;2602.156;1370.458;Comment;25;1;232;233;204;285;7;217;218;287;5;227;278;219;286;11;284;291;271;228;4;290;277;9;216;263;Base Layer With Dual Toning Flakes;0;0
Node;AmplifyShaderEditor.CommentaryNode;280;-654.1785,1302.273;Float;False;1024.147;552.1847;Simple fresnel blend;11;238;306;301;299;298;296;237;47;279;307;308;Blend Factor;0;0
...
Node;AmplifyShaderEditor.LerpOp;277;-185.3526,627.3438;Float;False;3;0;COLOR;0.0;False;1;COLOR;0.0,0,0,0;False;2;FLOAT;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.WireNode;291;411.4925,120.2562;Float;False;1;0;COLOR;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.CommentaryNode;281;941.591,1054.996;Float;False;1016.546;470.1129;This mirror layer that to mimc a coating layer;5;180;172;171;166;211;Coating Layer (Specular);0;0
...
Node;AmplifyShaderEditor.LerpOp;278;762.8654,-251.6517;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0.0;False;1;COLOR
Node;AmplifyShaderEditor.LerpOp;227;745.086,-103.8213;Float;False;3;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0.95,0,0,0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.LerpOp;217;1219.931,-40.31573;Float;False;3;0;COLOR;0.0;False;1;FLOAT4;0.0,0,0,0;False;2;FLOAT;0.0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.LerpOp;208;2395.602,1132.678;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0.0,0,0;False;2;FLOAT;0.0;False;1;FLOAT3
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2753.206,1085.791;Float;False;True;2;Float;ASEMaterialInspector;0;CustomLighting;ASESampleShaders/Double Layer Custom Surface;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;0;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;Relative;0;;-1;-1;-1;-1;0;14;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=6D88E939FB0F670D929E976CC50EB1F1FE91CD53