...
////// Lighting:
               ...
               // float3 SpLight = (DirectionalLight(normalDirection)[1] ) +PointLight(normalDirection ,PointLightPosition);
...
//HightLigtht
                float3 indirectSpecular = SBL(_IBL_Diffuse, viewReflectDirection, _Metallic_var.r);
